...
void computeNormal(int i, int j, std::vector<float>& normal) {
	...
	float p4[4]={i+1,h(i+1,j),j};

	float v1[3]={p2[0]-p1[0],p2[1]-p1[1],p2[2]-p1[2]};
	float v2[3]={p4[0]-p3[0],p4[1]-p3[1],p4[2]-p3[2]};

	float crossVetor[3];
	cross(v1,v2,crossVetor);
	normalize(crossVetor);

	normal.push_back(crossVetor[0]);
	normal.push_back(crossVetor[1]);
	normal.push_back(crossVetor[2]);
